  ...
  const addValue = (newValue) => {
    ...
    const saveData = async() =>
    {
      ...
      try{
        ...
        const formattedDateWithoutLetters = formattedDate.replace(/[a-zA-Z]+/g, '');
        setCurrentTime(formattedDateWithoutLetters);        
        ...
        <Dialog open={open} fullWidth onClose={handleClose}>
            ...
            <MenuItem value="Type">Type</MenuItem>
                ...
                <MenuItem value="Contract">Contract</MenuItem>
                    ...
                    <Grid item xs={6}>
                        <Select sx={{ backgroundColor: 'rgba(240,240,240,255)' }} onChange={(e)=>{settype(e.target.value)}} defaultValue="Location" fullWidth disableUnderline>
