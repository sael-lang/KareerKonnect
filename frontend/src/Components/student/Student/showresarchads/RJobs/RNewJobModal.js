...
console.log("asd")
    ...
    try{
        ...
        const res = await fetch("/Research/register", {
            method: "POST",
            headers: {
    ...
    return (
      ...
      <MenuItem value="Type">Type</MenuItem>
          ...
          <MenuItem value="Contract">Contract</MenuItem>
              ...
              <Grid item xs={6}>
                  <FilledInput value={companyName}onChange={(e)=>{setname(e.target.value)}} placeholder="Research Institution *" disableUnderline fullWidth />
              </Grid>
              <Grid item xs={6}>
                  <FilledInput value={link} onChange={(e)=>{seturl(e.target.value)}}placeholder="Institute's URL *" disableUnderline fullWidth />
              </Grid>
      ...
      <MenuItem value="Location">Location</MenuItem>
          ...
          <MenuItem value="In-office">In-office</MenuItem>
              ...
              <Grid item xs={6}>
                  <FilledInput value={companyUrl} onChange={(e)=>{setlink(e.target.value)}} placeholder="Research link *" disableUnderline fullWidth />
              </Grid>
