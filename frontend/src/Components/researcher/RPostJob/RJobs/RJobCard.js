...
const JobCard = (props) => {
    ...
    <Grid container alignItems="center">
        <Grid item xs>
            <Typography className={`${styles.name}`}variant="subtitle1">{props.title}</Typography>
        ...
        <Grid item container direction="column" alignItems="flex-end" xs>
            <Grid item xs>
                <Typography className={`${styles.name}`} variant="caption"> {props.postedOn} | {props.type} | {props.location}</Typography>
            </Grid>
